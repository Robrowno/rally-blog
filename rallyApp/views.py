...
def post_detail(request, slug):
    ...
    """
    Fetches post content from a unique slug generated by using the AutoSlugField extention in the
    Post model. This view also returns a list of comments posted by fetching user input in 
