...
def post_detail(request, slug):
    ...
    AutoSlugField extention in the Post model.
...
def login_func(request):
    ...
    """
    If a Post request is made, the details of the input are compared with
    an existing user in the database. If the account details exist,
    the user is redirected to the homepage.
    Otherwise, they are informed that there is no user
